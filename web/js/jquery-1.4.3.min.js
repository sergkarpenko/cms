...
(function(E, A) {
    ...
    var u = E.document,c = function() {
        ...
        b.extend = b.fn.extend = function() {
            ...
            for (; r < y; r++)if ((F = arguments[r]) != null)
            {
                for (I in F)
                {
                    K = i[I];
        ...
        c.fn[b] = function(d, e, f, h) {
            ...
            for (d = (d || "").split(" "); (k = d[l++]) != null;)
            {
                ...
                } else
                {
                    ...
                    {
                        s = 0;
                        for (var B = h.length; s < B; s++)c.event.add(h[s], "live." + Y(k, v), {data:e,selector:v,handler:f,origType:k,origHandler:f,preType:n})
                    } else
                    {
    ...
    E.attachEvent && !E.addEventListener && c(E).bind("unload", function() {
        for (var a in c.cache)if (c.cache[a].handle)
        {
            try
            {
    ...
    (function() {
            ...
            for (var p = g,q = [],t = j,x,C,P = j && j[0] && l.isXML(j[0]); g && j.length;)
            {
                for (var N in n.filter)if ((x = n.leftMatch[N].exec(g)) != null && x[2])
                {
                    ...
                    if (L.substr(L.length - 1) !== "\\")
                    {
                        ...
                        if (x)
                        {
                            for (var i = 0; (L = t[i]) != null; i++)if (L)
                            {
                                Q = R(L, x, i, t);
                                var r = m ^ !!Q;
                                if (o && Q != null)
                                {
                                    if (r)C = true; else t[i] = false;
                                } else if (r)
                                {
                                    q.push(L);
                                    C = true
        ...
        var n = l.selectors = {order:["ID","NAME","TAG"],match:{ID:/#((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,CLASS:/\.((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,NAME:/\[name=['"]*((?:[\w\u00c0-\uFFFF\-]|\\.)+)['"]*\]/,ATTR:/\[\s*((?:[\w\u00c0-\uFFFF\-]|\\.)+)\s*(?:(\S?=)\s*(['"]*)(.*?)\3|)\s*\]/,TAG:/^((?:[\w\u00c0-\uFFFF\*\-]|\\.)+)/,CHILD:/:(only|nth|last|first)-child(?:\((even|odd|[\dn+\-]*)\))?/,
            ...
            {
                return true;
            }m = g;case "last":for (; m = m.nextSibling;)if (m.nodeType === 1)return false;return true;case "nth":o = j[2];var p = j[3];if (o === 1 && p === 0)return true;var q = j[0],t = g.parentNode;if (t && (t.sizcache !== q || !g.nodeIndex))
            {
                var x = 0;
                for (m = t.firstChild; m; m = m.nextSibling)if (m.nodeType === 1)m.nodeIndex = ++x;
                t.sizcache = q
            }m = g.nodeIndex - p;return o === 0 ? m === 0 : m % o === 0 && m / o >= 0
            }
        },ID:function(g, j) {
            ...
            D = function(g, j) {
                ...
                if (f.call(g) === "[object Array]")
                {
                    Array.prototype.push.apply(o,
                            g);
                } else if (typeof g.length === "number")for (var p = g.length; m < p; m++)o.push(g[m]); else for (; g[m]; m++)o.push(g[m]);
                return o
            }
        }
        var w,G;
    ...
    c.fn.extend({find:function(a) {
                ...
                "find", a),d = 0,e = 0,f = this.length; e < f; e++)
        {
            ...
            if (e > 0)
            {
                for (var h = d; h < b.length; h++)for (var k = 0; k < d; k++)if (b[k] === b[h])
                {
                    b.splice(h--, 1);
                    break
                }
    ...
    c.extend({clean:function(a, b, d, e) {
        ...
        for (var b,d,e = c.cache,f = c.event.special,h = c.support.deleteExpando,k = 0,l; (l = a[k]) != null; k++)if (!(l.nodeName && c.noData[l.nodeName.toLowerCase()]))
        {
            if (d = l[c.expando])
            {
                if ((b = e[d]) && b.events)
