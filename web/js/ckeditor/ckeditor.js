...
(function() {
    if (!window.CKEDITOR)
    {
        window.CKEDITOR = (function() {
            var a = {timestamp:'A1QD',version:'3.2',revision:'5205',_:{},status:'unloaded',basePath:(function() {
    ...
    if (!a.editor)
    {
        ...
        a.editor = function(b, c, d) {
            var e = this;
            e._ = {instanceConfig:b,element:c};
            e.elementMode = d || 0;
            a.event.call(e);
            e._init();
        };
    ...
    {
        a.env = (function() {
            var b = navigator.userAgent.toLowerCase(),c = window.opera,d = {ie:/*@cc_on!@*/false,opera:!!c && c.version,webkit:b.indexOf(' applewebkit/') > -1,air:b.indexOf(' adobeair/') > -1,mac:b.indexOf('macintosh') > -1,quirks:document.compatMode == 'BackCompat',isCustomDomain:function() {
    ...
    d.node = function(h) {
        ...
        {
            switch (h.nodeType)
            {case 9:return new g(h);case 1:return new d.element(h);case 3:return new d.text(h);
            }
    ...
    e.extend(h.prototype, {type:1,addClass:function(i) {
        ...
        if (c && (b.ie7Compat || b.ie6Compat))return function(j) {
            var n = this;
            switch (j)
            {case 'class':j = 'className';break;case 'tabindex':var k = i.call(n, j);if (k !== 0 && n.$.tabIndex === 0)k = null;return k;break;case 'checked':var l = n.$.attributes.getNamedItem(j),m = l.specified ? l.nodeValue : n.$.checked;return m ? 'checked' : null;case 'hspace':return n.$.hspace;case 'style':return n.$.style.cssText;
            }
            return i.call(n, j);
        }; else return i;
        ...
        for (var j = 0; j < i.length; j++)
        {
            var k = i[j];
            switch (k.nodeName)
            {case 'class':if (this.getAttribute('class'))return true;case '_cke_expando':continue;default:if (k.specified)return true;
            }
        }
        return false;
    } : function() {
        ...
        var j = this;
        switch (i)
        {case 1:j.addClass('cke_on');j.removeClass('cke_off');j.removeClass('cke_disabled');break;case 0:j.addClass('cke_disabled');j.removeClass('cke_off');j.removeClass('cke_on');break;default:j.addClass('cke_off');j.removeClass('cke_on');j.removeClass('cke_disabled');break;
        }
    ...
    (function() {
        var l = {address:1,blockquote:1,dl:1,h1:1,h2:1,h3:1,h4:1,h5:1,h6:1,p:1,pre:1,li:1,dt:1,de:1},m = {body:1,div:1,table:1,tbody:1,tr:1,td:1,th:1,caption:1,form:1},n = function(o) {
            var p = o.getChildren();
    ...
    (function() {
        ...
        var p = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/,q = d.walker.whitespaces(true),r = d.walker.bookmark(false, true),s = function(t) {
            return r(t) && q(t);
        };
    ...
    (function() {
        ...
        d.range.prototype = {clone:function() {
            ...
            return{start:u.getAddress(t),end:A.isCollapsed ? null : v.getAddress(t),startOffset:w,endOffset:x,normalized:t,is2:true};
            ...
            switch (t)
            {case 1:if (this.collapsed)return;var u = this.getCommonAncestor(),v = this.document.getBody(),w,x,y,z,A,B = false,C,D,E = this.startContainer,F = this.startOffset;if (E.type == 3)
            {
                if (F)
                {
            ...
            var v = this;
            switch (u)
            {case 1:v.setStart(t, 0);break;case 2:if (t.type == 3)v.setStart(t, t.getLength()); else v.setStart(t, t.getChildCount());break;case 3:v.setStartBefore(t);break;case 4:v.setStartAfter(t);
            }
            l(v);
            ...
            switch (u)
            {case 1:v.setEnd(t, 0);
                break;case 2:if (t.type == 3)v.setEnd(t, t.getLength()); else v.setEnd(t, t.getChildCount());break;case 3:v.setEndBefore(t);break;case 4:v.setEndAfter(t);
            }
            l(v);
            ...
            var t = this.clone(),u = new d.walker(t),v = d.walker.bookmark(true),w = d.walker.whitespaces(true),x = function(z) {
                return w(z) && v(z);
            };
            t.evaluator = x;
            var y = u.next();
    ...
    a.skins.add('kama', (function() {
        ...
        return{preload:l,editor:{css:['editor.css']},dialog:{css:['dialog.css']},templates:{css:['templates.css']},margins:[0,0,0,0],init:function(n) {
            ...
            e.extend(n, {uiColor:null,getUiColor:function() {
                ...
                var w,x = s(a.document),y = '.cke_editor_' + e.escapeCssSelector(n.name),z = [y + ' .cke_wrapper',y + '_dialog .cke_dialog_contents',y + '_dialog a.cke_dialog_tab',y + '_dialog .cke_dialog_footer'].join(','),A = 'background-color: $color !important;';
                if (b.webkit)w = [
                    [z,A]
                ]; else w = z + '{' + A + '}';
    ...
    j.add('about', {requires:['dialog'],init:function(l) {
    ...
    (function() {
        ...
        j.add(l, {availableLangs:{en:1},init:function(n) {
            var o = this;
            n.addCommand(m, {exec:function() {
                var p = n.langCode;
    ...
    j.add('basicstyles', {requires:['styles','button'],init:function(l) {
    ...
    (function() {
        ...
        j.add('blockquote', {init:function(p) {
            p.addCommand('blockquote', o);
            p.ui.addButton('Blockquote', {label:p.lang.blockquote,command:'blockquote'});
            p.on('selectionChange', m);
        },requires:['domiterator']});
    })();
    j.add('button', {beforeInit:function(l) {
        l.ui.addHandler(1, k.button.handler);
    }});
    a.UI_BUTTON = 1;
    k.button = function(l) {
        e.extend(this, l, {title:l.label,className:l.className || l.command && 'cke_button_' + l.command || '',click:l.click || (function(m) {
            m.execCommand(l.command);
        })});
        this._ = {};
    };
    k.button.handler = {create:function(l) {
        return new k.button(l);
    }};
    k.button.prototype = {canGroup:true,render:function(l, m) {
        var n = b,o = this._.id = 'cke_' + e.getNextNumber();
        this._.editor = l;
        var p = {id:o,button:this,editor:l,focus:function() {
    ...
    k.button._ = {instances:[],keydown:function(l, m) {
    ...
    (function() {
        ...
        n.prototype = {exec:function(r, s) {
            var t = m(r, this.type);
            if (!t)alert(r.lang.clipboard[this.type + 'Error']);
            return t;
        }};
        var o = {canUndo:false,exec:c ? function(r) {
            r.focus();
            ...
            {case 1000 + 86:case 2000 + 45:var s = this.document.getBody();if (!c && s.fire('beforepaste'))r.cancel(); else if (b.opera || b.gecko && b.version < 10900)s.fire('paste');return;case 1000 + 88:case 2000 + 46:var t = this;this.fire('saveSnapshot');setTimeout(function() {
                t.fire('saveSnapshot');
            }, 0);
            }
        };
        ...
        function q(r, s, t) {
            ...
            u.getBody().append(y);
            if (!c && s != 'html')y.setStyles({position:'absolute',left:'-1000px',top:w.getStartElement().getDocumentPosition().y + 'px',width:'1px',height:'1px',overflow:'hidden'});
        ...
        ;
        j.add('clipboard', {requires:['dialog','htmldataprocessor'],init:function(r) {
    ...
    j.add('colorbutton', {requires:['panelbutton','floatpanel','styles'],init:function(l) {
        ...
        function p(r, s, t) {
            l.ui.add(r, 4, {label:t,title:t,className:'cke_button_' + r.toLowerCase(),modes:{wysiwyg:1},panel:{css:l.skin.editor.css,attributes:{role:'listbox','aria-label':n.panelTitle}},onBlock:function(u, v) {
                v.autoSize = true;
        ...
        ;
        function q(r, s) {
            var t = [],u = m.colorButton_colors.split(','),v = u.length + (m.colorButton_enableMore ? 2 : 1),w = e.addFunction(function(A, B) {
                if (A == '?')
                {
                ...
                l.focus();
                r.hide();
                var E = new a.style(m['colorButton_' + B + 'Style'], A && {color:A});
                l.fire('saveSnapshot');
                if (A)E.apply(l.document); else E.remove(l.document);
                l.fire('saveSnapshot');
            });
    ...
    j.add('contextmenu', {requires:['menu'],beforeInit:function(l) {
        l.contextMenu = new j.contextMenu(l);
        l.addCommand('contextMenu', {exec:function() {
            l.contextMenu.show(l.document.getBody());
        }});
    }});
    j.contextMenu = e.createClass({$:function(l) {
        ...
        this._.definiton = {panel:{className:l.skinClass + ' cke_contextmenu',attributes:{'aria-label':l.lang.common.options}}};
    },_:{onMenu:function(l, m, n, o) {
    ...
    (function() {
        j.add('div', {requires:['editingblock','domiterator','styles'],init:function(l) {
            var m = l.lang.div;
            l.addCommand('creatediv', new a.dialogCommand('creatediv'));
            l.addCommand('editdiv', new a.dialogCommand('editdiv'));
            l.addCommand('removediv', {exec:function(n) {
            ...
            if (l.addMenuItems)
            {
                l.addMenuItems({editdiv:{label:m.edit,command:'editdiv',group:'div',order:1},removediv:{label:m.remove,command:'removediv',group:'div',order:5}});
    ...
    a._.elementsPath = {click:function(l, m) {
        var n = a.instances[l];
        n.focus();
        ...
        {case 37:case 9:r = a.document.getById(q + (m + 1));if (!r)r = a.document.getById(q + '0');r.focus();return false;case 39:case 2000 + 9:r = a.document.getById(q + (m - 1));if (!r)r = a.document.getById(q + (p._.elementsPath.list.length - 1));r.focus();return false;case 27:p.focus();return false;case 13:case 32:this.click(l, m);return false;
        }
        return true;
    }};
    (function() {
        j.add('enterkey', {requires:['keystrokes','indent'],init:function(s) {
            var t = s.specialKeys;
            t[13] = q;
            t[2000 + 13] = p;
        }});
        j.enterkey = {enterBlock:function(s, t, u, v) {
            u = u || r(s);
            var w = u.document,x = t == 3 ? 'div' : 'p',y = u.splitBlock(x);
            if (!y)return;
            var z = y.previousBlock,A = y.nextBlock,B = y.wasStartOfBlock,C = y.wasEndOfBlock,D;
            if (A)
            {
                D = A.getParent();
                if (D.is('li'))
            ...
            u = u || r(s);
            var w = u.document,x = t == 3 ? 'div' : 'p',y = u.checkEndOfBlock(),z = new d.elementPath(s.getSelection().getStartElement()),A = z.block,B = A && z.block.getName(),C = false;
            if (!v && B == 'li')
            {
                n(s, t, u, v);
                return;
    ...
    (function() {
        ...
        ;
        j.add('entities', {afterInit:function(p) {
            var q = p.config;
    ...
    (function() {
        function l(m, n, o, p, q, r, s) {
            ...
            m.ui.addRichCombo(n, {label:p.label,title:p.panelTitle,className:'cke_' + (o == 'size' ? 'fontSize' : 'font'),panel:{css:m.skin.editor.css.concat(t.contentsCss),multiSelect:false,attributes:{'aria-label':p.panelTitle}},init:function() {
        ...
        ;
        j.add('font', {requires:['richcombo','styles'],init:function(m) {
            var n = m.config;
    ...
    j.add('format', {requires:['richcombo','styles'],init:function(l) {
        ...
        l.ui.addRichCombo('Format', {label:n.label,title:n.panelTitle,className:'cke_format',panel:{css:l.skin.editor.css.concat(m.contentsCss),multiSelect:false,attributes:{'aria-label':n.panelTitle}},init:function() {
    ...
    j.add('forms', {init:function(l) {
        ...
        if (c)
        {
            ...
            n && n.addRules({elements:{input:function(o) {
    ...
    if (c)h.prototype.hasAttribute = function(l) {
        ...
        {case 'class':return o.$.className.length > 0;case 'checked':return!!o.$.checked;case 'value':var n = o.getAttribute('type');if (n == 'checkbox' || n == 'radio')return o.$.value != 'on';break;default:
        }
        return!!(m && m.specified);
    };
    (function() {
        var l = {canUndo:false,exec:function(n) {
            n.insertElement(n.document.createElement('hr'));
        }},m = 'horizontalrule';
        j.add(m, {init:function(n) {
            n.addCommand(m, l);
    ...
    (function() {
        ...
        var z = /<(?:a|area|img|input)[\s\S]*?\s((?:href|src|name)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+)))/gi,A = /(?:<style(?=[ >])[^>]*>[\s\S]*<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,B = /<cke:encoded>([^<]*)<\/cke:encoded>/gi,C = /(<\/?)((?:object|embed|param|html|body|head|title)[^>]*>)/gi,D = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi,E = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi;
        ...
        ;
        function N(O, P) {
            var Q = [],R = /<\!--\{cke_temp(comment)?\}(\d*?)-->/g,S = [/<script[\s\S]*?<\/script>/gi,/<noscript[\s\S]*?<\/noscript>/gi].concat(P);
        ...
        ;
        j.add('htmldataprocessor', {requires:['htmlwriter'],init:function(O) {
        ...
        a.htmlDataProcessor.prototype = {toHtml:function(O, P) {
    ...
    (function() {
        ...
        function o(p, q, r) {
            ...
            {
                switch (r)
                {case 'left':u.cssClassName = t[0];break;case 'center':u.cssClassName = t[1];break;case 'right':u.cssClassName = t[2];break;case 'justify':u.cssClassName = t[3];break;
                }
    ...
    j.add('keystrokes', {beforeInit:function(l) {
    ...
    (function() {
        ...
        a.keystrokeHandler.prototype = {attach:function(o) {
            o.on('keydown', m, this);
    ...
    j.add('link', {init:function(l) {
        ...
        if (l.addMenuItems)l.addMenuItems({anchor:{label:l.lang.anchor.menu,command:'anchor',group:'anchor'},link:{label:l.lang.link.menu,command:'link',group:'link',order:1},unlink:{label:l.lang.unlink,command:'unlink',group:'link',order:5}});
        ...
        if (n)n.addRules({elements:{a:function(o) {
            var p = o.attributes;
    ...
    a.unlinkCommand.prototype = {exec:function(l) {
    ...
    (function() {
        var l = {ol:1,ul:1},m = /^[\n\r\t ]*$/;
        j.list = {listToArray:function(A, B, C, D, E) {
            ...
            for (var F = 0,G = A.getChildCount(); F < G; F++)
            {
                ...
                var I = {parent:A,indent:D,contents:[]};
                if (!E)
                {
            ...
            var E = A[C].parent.getDocument(),F = new d.documentFragment(E),G = null,H = C,I = Math.max(A[C].indent, 0),J = null,K = D == 1 ? 'p' : 'div';
            for (; ;)
            {
                var L = A[H];
                if (L.indent == I)
                ...
                } else if (L.indent == -1 && !C && L.grandparent)
                {
                    ...
                    else if (D != 2 && L.grandparent.getName() != 'td')J = E.createElement(K); else J = new d.documentFragment(E);
        ...
        s.prototype = {exec:function(A) {
            ...
            while (D.length > 0)
            {
                ...
                {
                    var Q = new d.elementPath(P),R = Q.elements,S = R.length,T = null,U = false,V = Q.blockLimit,W;
            ...
            while (J.length > 0)
            {
                ...
                if (this.state == 2)
                {
                    if (l[Y.root.getName()])p.call(this, A, Y, K, aa); else q.call(this, A, Y, aa);
    ...
    (function() {
        ...
        ;
        j.add('maximize', {init:function(q) {
            var r = q.lang,s = a.document,t = s.getWindow(),u,v,w,x = p(t, q),y = 2;
            q.addCommand('maximize', {modes:{wysiwyg:1,source:1},editorFocus:false,exec:function() {
                var z = q.container.getChild(1),A = q.getThemeSpace('contents');
                if (q.mode == 'wysiwyg')
                {
                ...
                if (this.state == 2)
                {
                    ...
                    if (c)s.$.documentElement.style.overflow = s.getBody().$.style.overflow = 'hidden'; else s.getBody().setStyles({overflow:'hidden',width:'0px',height:'0px'});
                    ...
                    z.$.offsetLeft;
                    z.setStyles({'z-index':q.config.baseFloatZIndex - 1,left:'0px',top:'0px'});
                    q.resize(E.width, E.height, null, true);
                    var F = z.getDocumentPosition();
                    z.setStyles({left:-1 * F.x + 'px',top:-1 * F.y + 'px'});
                ...
                this.toggleState();
                var I = this.uiItems[0],J = this.state == 2 ? r.maximize : r.minimize,K = q.element.getDocument().getById(I._.id);
            ...
            q.ui.addButton('Maximize', {label:r.maximize,command:'maximize'});
            q.on('mode', function() {
                q.getCommand('maximize').setState(y);
            }, null, null, 100);
        }});
    })();
    j.add('newpage', {init:function(l) {
        l.addCommand('newpage', {modes:{wysiwyg:1,source:1},exec:function(m) {
            var n = this;
    ...
    i.newpage_html = '';
    j.add('pagebreak', {init:function(l) {
        ...
        var m = l.dataProcessor,n = m && m.dataFilter;
        if (n)n.addRules({elements:{div:function(o) {
            var p = o.attributes,q = p && p.style,r = q && o.children.length == 1 && o.children[0],s = r && r.name == 'span' && r.attributes.style;
            if (s && /page-break-after\s*:\s*always/i.test(q) && /display\s*:\s*none/i.test(s))return l.createFakeParserElement(o, 'cke_pagebreak', 'div');
        }}});
    },requires:['fakeobjects']});
    j.pagebreakCmd = {exec:function(l) {
    ...
    (function() {
        j.add('pastefromword', {init:function(l) {
            var m = 0,n = function() {
                setTimeout(function() {
                    m = 0;
                }, 0);
            };
            l.addCommand('pastefromword', {canUndo:false,exec:function() {
                m = 1;
    ...
    (function() {
        var l = {exec:function(o) {
            var p = e.tryThese(function() {
                ...
                var q = window.Components.classes['@mozilla.org/widget/clipboard;1'].getService(window.Components.interfaces.nsIClipboard),r = window.Components.classes['@mozilla.org/widget/transferable;1'].createInstance(window.Components.interfaces.nsITransferable);
        ...
        ;
        j.add('pastetext', {init:function(o) {
        ...
        a.editor.prototype.insertText = function(o) {
            ...
            var p = this.getSelection().getStartElement().hasAscendant('pre', true) ? 2 : this.config.enterMode,q = p == 2,r = this.document.$,s = this,t;
    ...
    j.add('popup');
    e.extend(a.editor.prototype, {popup:function(l, m, n) {
        m = m || '80%';
        n = n || '70%';
    ...
    (function() {
        var l = {modes:{wysiwyg:1,source:1},canUndo:false,exec:function(n) {
    ...
    j.removeformat = {commands:{removeformat:{exec:function(l) {
    ...
    (function() {
        var l = {modes:{wysiwyg:1,source:1},exec:function(n) {
    ...
    (function() {
        ...
        var p = function() {
            var t = this,u = function() {
                ...
                var z = new window.scayt(x),A = q.instances[t.name];
                if (A)
                {
                    z.sLang = A.sLang;
                    z.option(A.option());
                ...
                var B = 'scaytButton',C = window.scayt.uiTags,D = [];
            ...
            t.on('contentDomUnload', function() {
                var x = a.document.getElementsByTag('script'),y = /^dojoIoScript(\d+)$/i,z = /^https?:\/\/svc\.spellchecker\.net\/spellcheck\/script\/ssrv\.cgi/i;
                for (var A = 0; A < x.count(); A++)
                {
                    var B = x.getItem(A),C = B.getId(),D = B.getAttribute('src');
            ...
            if (w)w.addRules({elements:{span:function(x) {
        ...
        j.scayt = {engineLoaded:false,instances:{},getScayt:function(t) {
            ...
            var v = 'svc.spellchecker.net/spellcheck3/lf/scayt/scayt21.js',w = t.config.scayt_srcUrl || u + '//' + v,x = q.parseUrl(w).path + '/';
            a._djScaytConfig = {baseUrl:x,addOnLoad:[function() {
                a.fireOnce('scaytReady');
            }],isDebug:false};
            a.document.getHead().append(a.document.createElement('script', {attributes:{type:'text/javascript',src:w}}));
            return null;
        },parseUrl:function(t) {
            var u;
        ...
        },s = {preserveState:true,editorFocus:false,exec:function(t) {
            if (q.isScaytReady(t))
            {
        ...
        j.add('scayt', {requires:['menubutton'],beforeInit:function(t) {
            ...
            t.addMenuGroup(C);
            var D = {};
            D.scaytToggle = {label:t.lang.scayt.enable,command:l,group:C};
            if (y[0] == 1)D.scaytOptions = {label:t.lang.scayt.options,group:C,onClick:function() {
                m = 'options';
                t.openDialog(l);
            }};
            if (y[1] == 1)D.scaytLangs = {label:t.lang.scayt.langs,group:C,onClick:function() {
                m = 'langs';
                t.openDialog(l);
            }};
            if (y[2] == 1)D.scaytDict = {label:t.lang.scayt.dictionariesTab,group:C,onClick:function() {
                m = 'dictionaries';
                t.openDialog(l);
            }};
            ...
            q.uiTabs = y;
            t.addMenuItems(D);
            t.ui.add('Scayt', 5, {label:t.lang.scayt.title,title:t.lang.scayt.title,className:'cke_button_scayt',onRender:function() {
                w.on('state', function() {
                ...
                return{scaytToggle:2,scaytOptions:F && q.uiTabs[0] ? 2 : 0,scaytLangs:F && q.uiTabs[1] ? 2 : 0,scaytDict:F && q.uiTabs[2] ? 2 : 0,scaytAbout:F && q.uiTabs[3] ? 2 : 0};
            }});
            if (t.contextMenu && t.addMenuItems)t.contextMenu.addListener(function(F) {
                if (!(q.isScaytEnabled(t) && F))return null;
                var G = q.getScayt(t),H = G.getWord(F.$);
                if (!H)return null;
                var I = G.getLang(),J = {},K = window.scayt.getSuggestion(H, I);
                ...
                u = {};
                v = {};
                var L = t.config.scayt_moreSuggestions || 'on',M = false,N = t.config.scayt_maxSuggestions;
                typeof N != 'number' && (N = 5);
                !N && (N = K.length);
                ...
                {
                    var R = 'scayt_suggestion_' + K[P].replace(' ', '_'),S = (function(W, X) {
                ...
                if (M)
                {
                    t.addMenuItem('scayt_moresuggest', {label:t.lang.scayt.moreSuggestions,group:'scayt_moresuggest',order:10,getItems:function() {
                        return u;
                    }});
    ...
    j.add('smiley', {requires:['dialog'],init:function(l) {
    ...
    (function() {
        ...
        j.add('showblocks', {requires:['wysiwygarea'],init:function(p) {
    ...
    (function() {
        ...
        var o = {preserveState:true,editorFocus:false,exec:function(p) {
            this.toggleState();
            this.refresh(p);
        },refresh:function(p) {
            var q = this.state == 1 ? 'addClass' : 'removeClass';
        ...
        j.add('showborders', {requires:['wysiwygarea'],modes:{wysiwyg:1},init:function(p) {
            ...
            if (r)r.addRules({elements:{table:function(t) {
                var u = t.attributes,v = u['class'],w = parseInt(u.border, 10);
                if (!w || w <= 0)u['class'] = (v || '') + ' ' + l;
            }}});
            if (s)s.addRules({elements:{table:function(t) {
            ...
            a.on('dialogDefinition', function(t) {
                ...
                {
                    var v = t.data.definition,w = v.getContents('info'),x = w.get('txtBorder'),y = x.commit;
    ...
    j.add('sourcearea', {requires:['editingblock'],init:function(l) {
        var m = j.sourcearea,n = a.document.getWindow();
        l.on('editingBlockReady', function() {
            var o,p;
            l.addMode('source', {load:function(q, r) {
                if (c && b.version < 8)q.setStyle('position', 'relative');
                l.textarea = o = new h('textarea');
                o.setAttributes({dir:'ltr',tabIndex:l.tabIndex,role:'textbox','aria-label':l.lang.editorTitle.replace('%1', l.name)});
                o.addClass('cke_source');
                o.addClass('cke_enable_context_menu');
                var s = {width:b.ie7Compat ? '99%' : '100%',height:'100%',resize:'none',outline:'none','text-align':'left'};
                if (c)
                {
                    p = function() {
                        o.hide();
    ...
    j.sourcearea = {commands:{source:{modes:{wysiwyg:1,source:1},exec:function(l) {
    ...
    (function() {
        var l;
        j.add('stylescombo', {requires:['richcombo','styles'],init:function(o) {
            var p = o.config,q = o.lang.stylesCombo,r = this.path,s;
            if (!l)l = a.stylesSet;
            var t = p.stylesCombo_stylesSet.split(':'),u = t[0],v = t[1];
            l.addExternal(u, v ? t.slice(1).join(':') : r + 'styles/' + u + '.js', '');
            o.ui.addRichCombo('Styles', {label:q.label,title:q.panelTitle,className:'cke_styles',panel:{css:o.skin.editor.css.concat(p.contentsCss),multiSelect:true,attributes:{'aria-label':q.panelTitle}},init:function() {
                var w = this;
                a.stylesSet.load(u, function(x) {
                    var y = x[u],z,A,B = [];
                    s = {};
                ...
                if (x.type == 2 && x.checkActive(A))x.remove(o.document); else x.apply(o.document);
                o.fire('saveSnapshot');
            },onRender:function() {
                o.on('selectionChange', function(w) {
                    var x = this.getValue(),y = w.data.path,z = y.elements;
                    for (var A = 0,B; A < z.length; A++)
                    {
                        B = z[A];
                        for (var C in s)
                        {
                            if (s[C].checkElementRemovable(B, true))
                            {
                ...
                var E = this;
                if (c)o.focus();
                var w = o.getSelection(),x = w.getSelectedElement(),y = x && x.getName(),z = new d.elementPath(x || w.getStartElement()),A = [0,0,0,0];
                E.showAll();
                E.unmarkAll();
                for (var B in s)
                {
    ...
    j.add('table', {init:function(l) {
        ...
        if (l.addMenuItems)l.addMenuItems({table:{label:n.menu,command:'tableProperties',group:'table',order:5},tabledelete:{label:n.deleteTable,command:'tableDelete',group:'table',order:1}});
    ...
    (function() {
        function l(E, F) {
            if (c)E.removeAttribute(F); else delete E[F];
        }
        ...
        function n(E) {
            var F = E.createBookmarks(),G = E.getRanges(),H = [],I = {};
            ...
            for (var K = 0; K < G.length; K++)
            {
                ...
                if (L.collapsed)
                {
                    var M = L.getCommonAncestor(),N = M.getAscendant('td', true) || M.getAscendant('th', true);
                    if (N)H.push(N);
                } else
                {
                    var O = new d.walker(L),P;
                    O.guard = J;
                    while (P = O.next())
                    {
                        var Q = P.getParent();
        ...
        function q(E) {
            ...
            {
                var F = n(E),G = F.length,H = [],I,J,K;
                for (var L = 0; L < G; L++)
                {
                    var M = F[L].getParent(),N = M.$.rowIndex;
                    !L && (J = N - 1);
                    H[N] = M;
                    L == G - 1 && (K = N + 1);
                }
                var O = M.getAscendant('table'),P = O.$.rows,Q = P.length;
                I = new h(K < Q && O.$.rows[K] || J > 0 && O.$.rows[J] || O.$.parentNode);
                for (L = H.length; L >= 0; L--)
                {
                    if (H[L])q(H[L]);
                }
                return I;
            } else if (E instanceof h)
            {
                ...
                if (O.$.rows.length == 1)O.remove(); else E.remove();
            }
            return 0;
        }
        ...
        ;
        function r(E, F) {
            var G = E.getStartElement(),H = G.getAscendant('td', true) || G.getAscendant('th', true);
            if (!H)return;
            var I = H.getAscendant('table'),J = H.$.cellIndex;
            for (var K = 0; K < I.$.rows.length; K++)
            {
                ...
                if (F)H.insertBefore(M); else H.insertAfter(M);
            }
        }
        ...
        function s(E) {
            ...
            {
                var H = E.getAscendant('table'),I = E.$.cellIndex;
        ...
        function t(E, F) {
            ...
            var I = H.clone();
            if (!c)I.appendBogus();
            if (F)I.insertBefore(H); else I.insertAfter(H);
        }
        ...
        function u(E) {
            ...
            } else if (E instanceof h)if (E.getParent().getChildCount() == 1)E.getParent().remove(); else E.remove();
        }
        ...
        function x(E) {
            ...
            for (var I = 0; I < F.length; I++)
            {
                ...
                for (var K = 0; K < F[I].cells.length; K++)
                {
                    ...
                    J++;
                    while (H[G][J])J++;
                    var M = isNaN(L.colSpan) ? 1 : L.colSpan,N = isNaN(L.rowSpan) ? 1 : L.rowSpan;
                    for (var O = 0; O < N; O++)
                    {
                        if (!H[G + O])H[G + O] = [];
        ...
        function y(E, F, G) {
            ...
            {
                if (G.is && H[I] == G.$)return I; else if (I == G)return new h(H[I]);
            }
            return G.is ? -1 : null;
        }
        ...
        function z(E, F, G) {
            ...
            {
                var J = E[I];
                if (typeof G == 'undefined')H.push(J[F]); else if (G.is && J[F] == G.$)return I; else if (I == G)return new h(J[F]);
            }
        ...
        function A(E, F, G) {
            ...
            var J,K = H[0],L = K.getAscendant('table'),M = x(L),N = M.length,O = M[0].length,P = K.getParent().$.rowIndex,Q = y(M, P, K);
            if (F)
            {
                var R;
                try
            ...
            var S = K.getDocument(),T = P,U = 0,V = 0,W = !G && new d.documentFragment(S),X = 0;
            for (var Y = 0; Y < H.length; Y++)
            {
                J = H[Y];
                var Z = J.getParent(),aa = J.getFirst(),ab = J.$.colSpan,ac = J.$.rowSpan,ad = Z.$.rowIndex,ae = y(M, ad, J);
                X += ab * ac;
                ...
                if (!G)
                {
                    ...
                    {
                        if (ad != T && aa && !(aa.isBlockBoundary && aa.isBlockBoundary({br:1})))
                        {
            ...
            if (!G)
            {
                W.moveChildren(K);
                if (!c)K.appendBogus();
                if (V >= O)K.removeAttribute('rowSpan'); else K.$.rowSpan = U;
                if (U >= N)K.removeAttribute('colSpan'); else K.$.colSpan = V;
                var ag = new d.nodeList(L.$.rows),ah = ag.count();
                for (Y = ah - 1; Y >= 0; Y--)
                {
                    var ai = ag.getItem(Y);
                    if (!ai.$.cells.length)
        ...
        function B(E, F) {
            var G = n(E);
            if (G.length > 1)return false; else if (F)return true;
            var H = G[0],I = H.getParent(),J = I.getAscendant('table'),K = x(J),L = I.$.rowIndex,M = y(K, L, H),N = H.$.rowSpan,O,P,Q,R;
            if (N > 1)
            {
                P = Math.ceil(N / 2);
                Q = Math.floor(N / 2);
                R = L + P;
                var S = new h(J.$.rows[R]),T = y(K, R),U;
                O = H.clone();
        ...
        function C(E, F) {
            var G = n(E);
            if (G.length > 1)return false; else if (F)return true;
            var H = G[0],I = H.getParent(),J = I.getAscendant('table'),K = x(J),L = I.$.rowIndex,M = y(K, L, H),N = H.$.colSpan,O,P,Q;
            if (N > 1)
            {
                P = Math.ceil(N / 2);
                Q = Math.floor(N / 2);
        ...
        ;
        var D = {thead:1,tbody:1,tfoot:1,td:1,tr:1,th:1};
        j.tabletools = {init:function(E) {
            var F = E.lang.table;
            E.addCommand('cellProperties', new a.dialogCommand('cellProperties'));
            a.dialog.add('cellProperties', this.path + 'dialogs/tableCell.js');
            E.addCommand('tableDelete', {exec:function(G) {
                var H = G.getSelection(),I = H && H.getStartElement(),J = I && I.getAscendant('table', true);
                if (!J)return;
                H.selectElement(J);
                var K = H.getRanges()[0];
                K.collapse();
                H.selectRanges([K]);
                if (J.getParent().getChildCount() == 1)J.getParent().remove(); else J.remove();
            }});
            E.addCommand('rowDelete', {exec:function(G) {
                var H = G.getSelection();
                w(q(H));
            }});
            E.addCommand('rowInsertBefore', {exec:function(G) {
                var H = G.getSelection();
                p(H, true);
            }});
            E.addCommand('rowInsertAfter', {exec:function(G) {
                var H = G.getSelection();
                p(H);
            }});
            E.addCommand('columnDelete', {exec:function(G) {
                var H = G.getSelection();
                s(H);
            }});
            E.addCommand('columnInsertBefore', {exec:function(G) {
                var H = G.getSelection();
                r(H, true);
            }});
            E.addCommand('columnInsertAfter', {exec:function(G) {
                var H = G.getSelection();
                r(H);
            }});
            E.addCommand('cellDelete', {exec:function(G) {
                var H = G.getSelection();
                u(H);
            }});
            E.addCommand('cellMerge', {exec:function(G) {
                w(A(G.getSelection()), true);
            }});
            E.addCommand('cellMergeRight', {exec:function(G) {
                w(A(G.getSelection(), 'right'), true);
            }});
            E.addCommand('cellMergeDown', {exec:function(G) {
                w(A(G.getSelection(), 'down'), true);
            }});
            E.addCommand('cellVerticalSplit', {exec:function(G) {
                w(B(G.getSelection()));
            }});
            E.addCommand('cellHorizontalSplit', {exec:function(G) {
                w(C(G.getSelection()));
            }});
            E.addCommand('cellInsertBefore', {exec:function(G) {
                var H = G.getSelection();
                t(H, true);
            }});
            E.addCommand('cellInsertAfter', {exec:function(G) {
                var H = G.getSelection();
                t(H);
            }});
            if (E.addMenuItems)E.addMenuItems({tablecell:{label:F.cell.menu,group:'tablecell',order:1,getItems:function() {
                var G = E.getSelection(),H = n(G);
            ...
            }},tablecell_insertBefore:{label:F.cell.insertBefore,group:'tablecell',command:'cellInsertBefore',order:5},tablecell_insertAfter:{label:F.cell.insertAfter,group:'tablecell',command:'cellInsertAfter',order:10},tablecell_delete:{label:F.cell.deleteCell,group:'tablecell',command:'cellDelete',order:15},tablecell_merge:{label:F.cell.merge,group:'tablecell',command:'cellMerge',order:16},tablecell_merge_right:{label:F.cell.mergeRight,group:'tablecell',command:'cellMergeRight',order:17},tablecell_merge_down:{label:F.cell.mergeDown,group:'tablecell',command:'cellMergeDown',order:18},tablecell_split_horizontal:{label:F.cell.splitHorizontal,group:'tablecell',command:'cellHorizontalSplit',order:19},tablecell_split_vertical:{label:F.cell.splitVertical,group:'tablecell',command:'cellVerticalSplit',order:20},tablecell_properties:{label:F.cell.title,group:'tablecellproperties',command:'cellProperties',order:21},tablerow:{label:F.row.menu,group:'tablerow',order:1,getItems:function() {
                return{tablerow_insertBefore:2,tablerow_insertAfter:2,tablerow_delete:2};
            }},tablerow_insertBefore:{label:F.row.insertBefore,group:'tablerow',command:'rowInsertBefore',order:5},tablerow_insertAfter:{label:F.row.insertAfter,group:'tablerow',command:'rowInsertAfter',order:10},tablerow_delete:{label:F.row.deleteRow,group:'tablerow',command:'rowDelete',order:15},tablecolumn:{label:F.column.menu,group:'tablecolumn',order:1,getItems:function() {
                return{tablecolumn_insertBefore:2,tablecolumn_insertAfter:2,tablecolumn_delete:2};
            }},tablecolumn_insertBefore:{label:F.column.insertBefore,group:'tablecolumn',command:'columnInsertBefore',order:5},tablecolumn_insertAfter:{label:F.column.insertAfter,group:'tablecolumn',command:'columnInsertAfter',order:10},tablecolumn_delete:{label:F.column.deleteColumn,group:'tablecolumn',command:'columnDelete',order:15}});
            if (E.contextMenu)E.contextMenu.addListener(function(G, H) {
                if (!G)return null;
                while (G)
                {
                    if (G.getName() in D)return{tablecell:2,tablerow:2,tablecolumn:2};
                    G = G.getParent();
                }
                return null;
            });
    ...
    j.add('specialchar', {init:function(l) {
        var m = 'specialchar';
    ...
    (function() {
        var l = {editorFocus:false,modes:{wysiwyg:1,source:1}},m = {exec:function(o) {
            o.container.focusNext(true, o.tabIndex);
        }},n = {exec:function(o) {
            o.container.focusPrevious(true, o.tabIndex);
        }};
        j.add('tab', {requires:['keystrokes'],init:function(o) {
    ...
    h.prototype.focusPrevious = function(l, m) {
        var v = this;
        var n = v.$,o = m === undefined ? v.getTabIndex() : m,p,q,r,s = 0,t,u = v.getDocument().getBody().getLast();
    ...
    (function() {
        j.add('templates', {requires:['dialog'],init:function(n) {
    ...
    (function() {
        ...
        var m = {toolbarFocus:{modes:{wysiwyg:1,source:1},exec:function(n) {
            if (n.toolbox)
            {
        ...
        j.add('toolbar', {init:function(n) {
            var o = function(p, q) {
                ...
                {case 39:case 9:do{
                    ...
                    p = r;
                } while (p && !p.focus)if (p)p.focus(); else n.toolbox.focus();return false;case 37:case 2000 + 9:do{
                    r = p.previous;
                    if (!r)
                    {
                    ...
                    p = r;
                } while (p && !p.focus)if (p)p.focus(); else
                {
                    var u = n.toolbox.toolbars[n.toolbox.toolbars.length - 1].items;
                    u[u.length - 1].focus();
                }return false;case 27:n.focus();return false;case 13:case 32:p.execute();return false;
                }
                return true;
            };
            n.on('themeSpace', function(p) {
                ...
                {
                    n.toolbox = new l();
                    var q = 'cke_' + e.getNextNumber(),r = ['<div class="cke_toolbox" role="toolbar" aria-labelledby="',q,'"'],s = n.config.toolbarStartupExpanded !== false,t;
                    r.push(s ? '>' : ' style="display:none">');
                    r.push('<span id="', q, '" class="cke_voice_label">', n.lang.toolbar, '</span>');
                    var u = n.toolbox.toolbars,v = n.config.toolbar instanceof Array ? n.config.toolbar : n.config['toolbar_' + n.config.toolbar];
                    ...
                    if (n.config.toolbarCanCollapse)
                    {
                        ...
                        n.addCommand('toolbarCollapse', {exec:function(H) {
                            var I = a.document.getById(G),J = I.getPrevious(),K = H.getThemeSpace('contents'),L = J.getParent(),M = parseInt(K.$.style.height, 10),N = L.$.offsetHeight,O = !J.isVisible();
                            if (!O)
                            {
                                J.hide();
    ...
    k.separator = {render:function(l, m) {
    ...
    (function() {
        j.add('undo', {requires:['selection','wysiwygarea'],init:function(r) {
            var s = new n(r),t = r.addCommand('undo', {exec:function() {
                if (s.undo())
                {
                    r.selectionChange();
                    this.fire('afterUndo');
                }
            },state:0,canUndo:false}),u = r.addCommand('redo', {exec:function() {
                if (s.redo())
                {
                    r.selectionChange();
                    this.fire('afterRedo');
        ...
        l.prototype = {equals:function(r, s) {
        ...
        n.prototype = {type:function(r) {
            var s = r && r.data.getKey(),t = s in p,u = s in o,v = this.lastKeystroke in o,w = u && s == this.lastKeystroke,x = s in q,y = this.lastKeystroke in q,z = !u && !x,A = u && !w,B = !(t || this.typing) || z && (v || y);
            if (B || A)
            {
    ...
    i.undoStackSize = 20;
    (function() {
        var l = {table:1,pre:1},m = /\s*<(p|div|address|h\d|center)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\1>)?\s*(?=$|<\/body>)/gi;
        ...
        function n(v) {
            if (this.mode == 'wysiwyg')
            {
                this.focus();
                this.fire('saveSnapshot');
                var w = this.getSelection(),x = v.data;
        ...
        function o(v) {
            if (this.mode == 'wysiwyg')
            {
                this.focus();
                this.fire('saveSnapshot');
                var w = v.data,x = w.getName(),y = f.$block[x],z = this.getSelection(),A = z.getRanges(),B = z.isLocked;
                if (B)z.unlock();
                var C,D,E,F;
                for (var G = A.length - 1; G >= 0; G--)
                {
                    ...
                    D = !G && w || w.clone(true);
                    var H,I;
                    if (y)while ((H = C.getCommonAncestor(false, true)) && (I = f[H.getName()]) && !(I && I[x]))
                    {
                        if (H.getName() in f.span)C.splitElement(H); else if (C.checkStartOfBlock() && C.checkEndOfBlock())
                        {
                            C.setStartBefore(H);
                            C.collapse(true);
                            H.remove();
        ...
        ;
        function u(v) {
            var w = v.editor,x = v.data.path,y = x.blockLimit,z = v.data.selection,A = z.getRanges()[0],B = w.document.getBody(),C = w.config.enterMode;
            if (C != 2 && A.collapsed && y.getName() == 'body' && !x.block)
            {
                ...
                {
                    var F = D.getPrevious(q),G = D.getNext(q);
            ...
            {
                p(w);
                if (!c)B.appendBogus(); else B.append(w.document.createText('\xa0'));
            }
        }

        ;
        j.add('wysiwygarea', {requires:['editingblock'],init:function(v) {
            var w = v.config.enterMode != 2 ? v.config.enterMode == 3 ? 'div' : 'p' : false,x = v.lang.editorTitle.replace('%1', v.name);
            v.on('editingBlockReady', function() {
                var A,B,C,D,E,F,G = b.isCustomDomain(),H = function(K) {
                    if (B)B.remove();
                    E = 0;
                    ...
                    A.append(B);
                },I = '<script id="cke_actscrpt" type="text/javascript" cke_temp="1">' + (G ? 'document.domain="' + document.domain + '";' : '') + 'parent.CKEDITOR._["contentDomReady' + v.name + '"]( window );' + '</script>',J = function(K) {
                    if (E)return;
                    E = 1;
                    v.fire('ariaWidget', B);
                    var L = K.document,M = L.body,N = L.getElementById('cke_actscrpt');
                    ...
                    P.on('focus', function() {
                        if (b.gecko)
                        {
                            ...
                            if (!U.nextSibling && 'BR' == U.tagName && U.hasAttribute('_moz_editor_bogus_node'))
                            {
                                ...
                                if (v.config.enterMode == 2)L.createElement('br', {attributes:{_moz_dirty:''}}).replace(W); else W.remove();
                            }
                        }
                    ...
                    if (c)
                    {
                        L.on('keydown', function(U) {
                            ...
                            if (V in {8:1,46:1})
                            {
                                var W = v.getSelection(),X = W.getSelectedElement();
                                if (X)
                                {
                                    v.fire('saveSnapshot');
                ...
                v.addMode('wysiwyg', {load:function(K, L, M) {
                    A = K;
                    if (c && b.quirks)K.setStyle('position', 'relative');
                    v.mayBeDirty = true;
                    F = true;
                    if (M)this.loadSnapshotData(L); else this.loadData(L);
                },loadData:function(K) {
                    C = true;
                    var L = v.config,M = L.fullPage,N = L.docType,O = '<style type="text/css" cke_temp="1">' + v._.styles.join('\n') + '</style>';
                    !M && (O = e.buildStyleHtml(v.config.contentsCss) + O);
                    ...
                    var K = v.config,L = K.fullPage,M = L && v.docType,N = B.getFrameDocument(),O = L ? N.getDocumentElement().getOuterHtml() : N.getBody().getHtml();
        ...
        if (b.gecko)(function() {
            var v = document.body;
            if (!v)window.addEventListener('load', arguments.callee, false); else v.setAttribute('onpageshow', v.getAttribute('onpageshow') + ';event.persisted && CKEDITOR.tools.callFunction(' + e.addFunction(function() {
                var w = a.instances,x,y;
                for (var z in w)
                {
                    x = w[z];
                    y = x.document;
    ...
    j.add('wsc', {requires:['dialog'],init:function(l) {
    ...
    (function() {
        ...
        a.dialog = function(K, L) {
            ...
            this._ = {editor:K,element:O.element,name:L,contentSize:{width:0,height:0},size:{width:0,height:0},updateSize:false,contents:{},buttons:{},accessKeyMap:{},tabs:{},tabIdList:[],currentTabId:null,currentTabIndex:null,pageCount:0,lastTab:null,tabBarMode:false,focusList:[],currentFocusIndex:0,hasFocus:false};
            this.parts = O.parts;
            e.setTimeout(function() {
            ...
            var Y = [],Z = a.dialog._.uiElementBuilders.hbox.build(this, {type:'hbox',className:'cke_dialog_footer_buttons',widths:[],children:M.buttons}, Y).getChild();
        ...
        a.dialog.prototype = {resize:(function() {
            ...
            var K = M._.element.getFirst(),L = M._.size = {width:K.$.offsetWidth || 0,height:K.$.offsetHeight || 0};
            ...
            var W = this;
            var L = [],M = K.label ? ' title="' + e.htmlEncode(K.label) + '"' : '',N = K.elements,O = a.dialog._.uiElementBuilders.vbox.build(W, {type:'vbox',className:'cke_dialog_page_contents',children:K.elements,expand:!!K.expand,padding:K.padding,style:K.style || 'width: 100%;' + (b.ie6Compat ? '' : 'height: 100%;')}, L),P = h.createFromHtml(L.join(''));
            P.setAttribute('role', 'tabpanel');
            var Q = b,R = K.id + '_' + e.getNextNumber(),S = h.createFromHtml(['<a class="cke_dialog_tab"',W._.pageCount > 0 ? ' cke_last' : 'cke_first',M,!!K.hidden ? ' style="display:none"' : '',' id="',R,'"',Q.gecko && Q.version >= 10900 && !Q.hc ? '' : ' href="javascript:void(0)"',' tabIndex="-1"',' hidefocus="true"',' role="tab">',K.label,'</a>'].join(''));
            P.setAttribute('aria-labelledby', R);
            if (W._.pageCount === 0)W.parts.dialog.addClass('cke_single_page'); else W.parts.dialog.removeClass('cke_single_page');
            W._.tabs[K.id] = [S,P];
        ...
        e.extend(a.dialog, {add:function(K, L) {
            ...
            var K = function(L, M) {
                M = M || {};
                return e.extend({id:'ok',type:'button',label:L.lang.common.ok,'class':'cke_dialog_ui_button_ok',onClick:function(N) {
                    var O = N.data.dialog;
            ...
            var K = function(L, M) {
                M = M || {};
                return e.extend({id:'cancel',type:'button',label:L.lang.common.cancel,'class':'cke_dialog_ui_button_cancel',onClick:function(N) {
                    var O = N.data.dialog;
        ...
        var p = {resizable:0,minWidth:600,minHeight:400,buttons:[a.dialog.okButton,a.dialog.cancelButton]},q = function(K, L, M) {
        ...
        t.prototype = {getContents:function(K) {
        ...
        function v(K) {
            var L = null,M = null,N = K.getElement().getFirst(),O = K.getParentEditor(),P = O.config.dialog_magnetDistance,Q = O.skin.margins || [0,0,0,0];
            if (typeof P == 'undefined')P = 20;
            function R(T) {
                var U = K.getSize(),V = a.document.getWindow().getViewPaneSize(),W = T.data.$.screenX,X = T.data.$.screenY,Y = W - L.x,Z = X - L.y,aa,ab;
                L = {x:W,y:X};
                M.x += Y;
                M.y += Z;
        ...
        ;
        function w(K) {
            var L = K.definition,M = L.minWidth || 0,N = L.minHeight || 0,O = L.resizable,P = K.getParentEditor().skin.margins || [0,0,0,0];
            ...
            ;
            var U = null,V = null,W = K._.editor.config.magnetDistance,X = ['tl','t','tr','l','r','bl','b','br'];
            ...
            ;
            function Z(ab) {
                var ac = ab.data.$.screenX,ad = ab.data.$.screenY,ae = ac - U.x,af = ad - U.y,ag = a.document.getWindow().getViewPaneSize(),ah = ab.listenerData.part;
        ...
        var x,y,z = function(K) {
            ...
            if (!y)
            {
                var M = K.config.dialog_backgroundCoverColor || 'white',N = ['<div style="position: ',b.ie6Compat ? 'absolute' : 'fixed','; z-index: ',K.config.baseFloatZIndex,'; top: 0px; left: 0px; ',!b.ie6Compat ? 'background-color: ' + M : '','" id="cke_dialog_background_cover">'];
                if (b.ie6Compat)
                {
                    var O = b.isCustomDomain(),P = "<html><body style=\\'background-color:" + M + ";\\'></body></html>";
            ...
            var L = K.data.$.ctrlKey || K.data.$.metaKey,M = K.data.$.altKey,N = K.data.$.shiftKey,O = String.fromCharCode(K.data.$.keyCode),P = B[(L ? 'CTRL+' : '') + (M ? 'ALT+' : '') + (N ? 'SHIFT+' : '') + O];
        ...
        (function() {
            k.dialog = {uiElement:function(K, L, M, N, O, P, Q) {
                if (arguments.length < 4)return;
                var R = (N.call ? N(L) : N) || 'div',S = ['<',R,' '],T = (O && O.call ? O(L) : O) || {},U = (P && P.call ? P(L) : P) || {},V = (Q && Q.call ? Q.call(this, K, L) : Q) || '',W = this.domId = U.id || e.getNextNumber() + '_uiElement',X = this.id = L.id,Y;
                U.id = W;
                var Z = {};
                ...
                if (arguments.length < 4)return;
                this._ || (this._ = {});
                var P = this._.children = L,Q = O && O.widths || null,R = O && O.height || null,S = {},T,U = function() {
        ...
        k.dialog.uiElement.prototype = {getElement:function() {
            ...
            return this;
        },eventProcessors:{onLoad:function(K, L) {
            K.on('load', L, this);
        },onShow:function(K, L) {
            K.on('show', L, this);
        },onHide:function(K, L) {
        ...
        k.dialog.hbox.prototype = e.extend(new k.dialog.uiElement(), {getChild:function(K) {
            var L = this;
        ...
        a.dialogCommand.prototype = {exec:function(K) {
    ...
    e.extend(a.editor.prototype, {openDialog:function(l, m) {
        var n = a.dialog._.dialogDefinitions[l];
        if (typeof n == 'function')
        {
            var o = this._.storedDialogs || (this._.storedDialogs = {}),p = o[l] || (o[l] = new a.dialog(this, l));
            m && m.call(p, p);
            p.show();
            return p;
        } else if (n == 'failed')throw new Error('[CKEDITOR.dialog.openDialog] Dialog "' + l + '" failed when loading definition.');
        var q = a.document.getBody(),r = q.$.style.cursor,s = this;
    ...
    a.STYLE_OBJECT = 3;
    (function() {
        var l = {address:1,div:1,h1:1,h2:1,h3:1,h4:1,h5:1,h6:1,p:1,pre:1},m = {a:1,embed:1,hr:1,img:1,li:1,object:1,ol:1,table:1,td:1,tr:1,ul:1},n = /\s*(?:;\s*|$)/;
        ...
        a.style.prototype = {apply:function(L) {
            K.call(this, L, false);
        },remove:function(L) {
            K.call(this, L, true);
            ...
            switch (this.type)
            {case 1:return this.checkElementRemovable(L.block || L.blockLimit, true);case 2:var M = L.elements;for (var N = 0,O; N < M.length; N++)
            {
                O = M[N];
        ...
        function p(L) {
            ...
            if (L.collapsed)
            {
                ...
                if (P)
                {
                    ...
                    {
                        var V = O.elements[Q];
                        if (V.equals(P))break; else if (V.match)continue; else V = V.clone();
                        V.append(U);
                        U = V;
                    }
        ...
        function r(L, M) {
            ...
            if (P)M = w(L, M); else if (Q)M = v(t(L), M); else L.moveChildren(M);
            M.replace(L);
            if (N)s(M);
        }
        ...
        function v(L, M) {
            ...
            for (var O = 0; O < L.length; O++)
            {
                ...
                P = u(P, /^[ \t]+|[ \t]+$/g, function(R, S, T) {
                    if (R.length == 1)return '&nbsp;'; else if (!S)return e.repeat('&nbsp;', R.length - 1) + ' ';
        ...
        function I(L) {
            ...
            if (N)
            {
                ...
                {
                    var P = N[O],Q,R,S;
                    if (typeof P == 'string')Q = P.toLowerCase(); else
                    {
    ...
    (function() {
        ...
        ;
        var m = /^[\r\n\t ]+$/,n = d.walker.bookmark();
        l.prototype = {getNextParagraph:function(o) {
            var O = this;
            var p,q,r,s,t;
            if (!O._.lastNode)
            {
            ...
            if (!p)
            {
                ...
                p = H.block;
                if (!p && !O.enforceRealBlocks && J[I.getName()] && q.checkStartOfBlock() && q.checkEndOfBlock())p = I; else if (!p || O.enforceRealBlocks && p.getName() == 'li')
                {
    ...
    j.add('panelbutton', {requires:['button'],beforeInit:function(l) {
    ...
    (function() {
        ...
        k.panelButton = e.createClass({base:k.button,$:function(m) {
            var o = this;
            var n = m.panel;
            delete m.panel;
            o.base(m);
        ...
        }}},proto:{createPanel:function(m) {
            var n = this._;
            if (n.panel)return;
            var o = this._.panelDefinition || {},p = this._.panelDefinition.block,q = o.parent || a.document.getBody(),r = this._.panel = new k.floatPanel(m, q, o),s = r.addBlock(n.id, p),t = this;
            r.onShow = function() {
    ...
    (function() {
        ...
        ;
        k.floatPanel = e.createClass({$:function(o, p, q, r) {
            q.forceIFrame = true;
            var s = p.getDocument(),t = n(o, s, p, q, r || 0),u = t.element,v = u.getFirst().getFirst();
            this.element = u;
            this._ = {panel:t,parentElement:p,definition:q,document:s,iframe:v,children:[],dir:o.lang.dir};
        },proto:{addBlock:function(o, p) {
            ...
            e.setTimeout(function() {
                ...
                var D = e.bind(function() {
                    ...
                    var I = t.element,J = I.getWindow(),K = J.getScrollPosition(),L = J.getViewPaneSize(),M = {height:I.$.offsetHeight,width:I.$.offsetWidth};
    ...
    j.add('menu', {beforeInit:function(l) {
    ...
    (function() {
        a.menu = e.createClass({$:function(m, n) {
            var q = this;
            n = q._.definition = n || {};
            ...
            q.items = [];
            q._.level = n.level || 1;
            var o = e.extend({}, n.panel, {css:m.skin.editor.css,level:q._.level - 1,block:{}}),p = o.block.attributes = o.attributes || {};
            !p.role && (p.role = 'menu');
            q._.panelDefinition = o;
        },_:{showSubMenu:function(m) {
            var u = this;
    ...
    a.menuItem = e.createClass({$:function(l, m, n) {
        var o = this;
        e.extend(o, n, {order:0,className:'cke_button_' + m});
        o.group = l._.menuGroups[o.group];
        o.editor = l;
        o.name = m;
    },proto:{render:function(l, m, n) {
        var u = this;
        var o = l.id + String(m),p = typeof u.state == 'undefined' ? 2 : u.state,q = ' cke_' + (p == 1 ? 'on' : p == 0 ? 'disabled' : 'off'),r = u.label;
    ...
    (function() {
        ...
        ;
        var q = {exec:function(s) {
            switch (s.mode)
            {case 'wysiwyg':s.document.$.execCommand('SelectAll', false, null);break;case 'source':
            }
        },canUndo:false};
        j.add('selection', {init:function(s) {
        ...
        var r = {img:1,hr:1,li:1,table:1,tr:1,td:1,th:1,embed:1,object:1,ol:1,ul:1,a:1,input:1,form:1,select:1,textarea:1,button:1,fieldset:1,th:1,thead:1,tfoot:1};
        d.selection.prototype = {getNative:c ? function() {
            ...
            var s = function(t, u) {
                ...
                for (var y = 0; y < w.length; y++)
                {
                    ...
                    if (z.nodeType == 1)
                    {
                        ...
                        x.collapse();
                        if (A > 0)break; else if (!A || B == 1 && A == -1)return{container:v,offset:y}; else if (!B)return{container:v,offset:y + 1};
                        x = null;
                    }
                }
                if (!x)
            ...
            var t,u = z.getNative();
            switch (z.getType())
            {case 3:return z.getSelectedElement();case 2:var v = z.getRanges()[0];if (v)if (!v.collapsed)
            {
                v.optimize();
                for (; ;)
                {
    ...
    (function() {
        var l = {elements:{$:function(m) {
            var n = m.attributes,o = n && n._cke_realelement,p = o && new a.htmlParser.fragment.fromHtml(decodeURIComponent(o)),q = p && p.children[0];
        ...
        j.add('fakeobjects', {requires:['htmlwriter'],afterInit:function(m) {
            var n = m.dataProcessor,o = n && n.htmlFilter;
            if (o)o.addRules(l);
        }});
    })();
    a.editor.prototype.createFakeElement = function(l, m, n, o) {
        var p = this.lang.fakeobjects,q = {'class':m,src:a.getUrl('images/spacer.gif'),_cke_realelement:encodeURIComponent(l.getOuterHtml()),_cke_real_node_type:l.type,alt:p[n] || p.unknown};
    ...
    a.editor.prototype.createFakeParserElement = function(l, m, n, o) {
        ...
        l.writeHtml(r);
        q = r.getHtml();
        var s = {'class':m,src:a.getUrl('images/spacer.gif'),_cke_realelement:encodeURIComponent(q),_cke_real_node_type:l.type,alt:p[n] || p.unknown};
    ...
    j.add('richcombo', {requires:['floatpanel','listblock','button'],beforeInit:function(l) {
        l.ui.addHandler(3, k.richCombo.handler);
    }});
    a.UI_RICHCOMBO = 3;
    k.richCombo = e.createClass({$:function(l) {
        var n = this;
    ...
    },statics:{handler:{create:function(l) {
        return new k.richCombo(l);
    }}},proto:{renderHtml:function(l) {
        var m = [];
        this.render(l, m);
        return m.join('');
    },render:function(l, m) {
        ...
        }, this),q = {id:o,combo:this,focus:function() {
        ...
        var r = e.addFunction(function(s, t) {
            ...
            switch (u)
            {case 13:case 32:case 40:e.callFunction(p, t);break;default:q.onkey(q, u);
            }
            s.preventDefault();
        });
        ...
        var m = this._.panelDefinition,n = this._.panelDefinition.block,o = m.parent || a.document.getBody(),p = new k.floatPanel(l, o, m),q = p.addListBlock(this.id, n),r = this;
        p.onShow = function() {
    ...
    a.htmlWriter = e.createClass({base:a.htmlParser.basicWriter,$:function() {
        ...
        n._.rules = {};
        var l = f;
        for (var m in e.extend({}, l.$nonBodyContent, l.$block, l.$listItem, l.$tableContent))n.setRules(m, {indent:true,breakBeforeOpen:true,breakAfterOpen:true,breakBeforeClose:!l[m]['#'],breakAfterClose:true});
    ...
    j.add('menubutton', {requires:['button','contextmenu'],beforeInit:function(l) {
    ...
    (function() {
        ...
        k.menuButton = e.createClass({base:k.button,$:function(m) {
            var n = m.panel;
            delete m.panel;
            this.base(m);
            this.hasArrow = true;
    ...
    (function() {
        ...
        }},q = e.extend({}, k.dialog.uiElement.prototype.eventProcessors, {onChange:function(t, u) {
        ...
        e.extend(k.dialog, {labeledElement:function(t, u, v, w) {
            if (arguments.length < 4)return;
            var x = l.call(this, u);
            ...
            var y = this._.children = [],z = function() {
                ...
                {
                    var B = {type:'hbox',widths:u.widths,padding:0,children:[
                        {type:'html',html:'<label class="cke_dialog_ui_labeled_label" id="' + x.labelId + '"' + ' for="' + x.inputId + '"' + ' style="' + u.labelStyle + '">' + e.htmlEncode(u.label) + '</span>'},
                        {type:'html',html:'<span class="cke_dialog_ui_labeled_content">' + w.call(this, t, u) + '</span>'}
                    ]};
            ...
            if (arguments.length < 3)return;
            l.call(this, u);
            var w = this._.inputId = e.getNextNumber() + '_textInput',x = {'class':'cke_dialog_ui_input_' + u.type,id:w,type:'text'},y;
            ...
            if (u.validate)this.validate = u.validate;
            var x = function() {
                var y = e.extend({}, u, {id:u.id ? u.id + '_checkbox' : e.getNextNumber() + '_checkbox'}, true),z = [],A = e.getNextNumber() + '_label',B = {'class':'cke_dialog_ui_checkbox_input',type:'checkbox','aria-labelledby':A};
                s(y);
            ...
            var w = [],x = this,y = function() {
                var z = [],A = [],B = {'class':'cke_dialog_ui_radio_item','aria-labelledby':this._.labelId},C = u.id ? u.id + '_radio' : e.getNextNumber() + '_radio';
                for (var D = 0; D < u.items.length; D++)
                {
                    var E = u.items[D],F = E[2] !== undefined ? E[2] : E[0],G = E[1] !== undefined ? E[1] : E[0],H = e.getNextNumber() + '_radio_input',I = H + '_label',J = e.extend({}, u, {id:H,title:null,type:null}, true),K = e.extend({}, J, {title:F}, true),L = {type:'radio','class':'cke_dialog_ui_radio_input',name:C,value:G,'aria-labelledby':I},M = [];
            ...
            var x = function() {
                var y = e.extend({}, u, {id:u.id ? u.id + '_select' : e.getNextNumber() + '_select'}, true),z = [],A = [],B = {id:w.inputId,'class':'cke_dialog_ui_input_select','aria-labelledby':this._.labelId};
            ...
            var x = function() {
                ...
                var y = b.isCustomDomain(),z = ['<iframe frameborder="0" allowtransparency="0" class="cke_dialog_ui_input_file" id="',w.frameId,'" title="',u.label,'" src="javascript:void('];
        ...
        k.dialog.labeledElement.prototype = e.extend(new k.dialog.uiElement(), {setLabel:function(t) {
        ...
        },eventProcessors:e.extend({}, k.dialog.uiElement.prototype.eventProcessors, {onClick:function(t, u) {
            this.on('click', u);
        ...
        },eventProcessors:{onChange:function(t, u) {
        ...
        k.dialog.radio.prototype = e.extend(new k.dialog.uiElement(), {setValue:function(t) {
        ...
        k.dialog.file.prototype = e.extend(new k.dialog.labeledElement(), p, {getInputElement:function() {
            ...
            var t = a.document.getById(this._.frameId),u = t.getFrameDocument(),v = this._.definition,w = this._.buttons;
            ...
            return '';
        },eventProcessors:q,keyboardFocusable:true}, true);
    ...
    j.add('panel', {beforeInit:function(l) {
    ...
    k.panel.handler = {create:function(l) {
        return new k.panel(l);
    }};
    k.panel.prototype = {renderHtml:function(l) {
        var m = [];
        this.render(l, m);
        return m.join('');
    },render:function(l, m) {
        ...
        var q = this;
        var m = q._.blocks,n = m[l],o = q._.currentBlock,p = q.forceIFrame ? q.document.getById('cke_' + q.id + '_frame') : q._.holder;
        if (o)
        {
    ...
    k.panel.block = e.createClass({$:function(l, m) {
        var n = this;
        n.element = l.append(l.getDocument().createElement('div', {attributes:{tabIndex:-1,'class':'cke_panel_block',role:'presentation'},styles:{display:'none'}}));
        if (m)e.extend(n, m);
        n.keys = {};
        n._.focusIndex = -1;
        n.element.disableContextMenu();
    },_:{markItem:function(l) {
        if (l == -1)return;
        var m = this.element.getElementsByTag('a'),n = m.getItem(this._.focusIndex = l);
        ...
        var m = q.keys[l];
        switch (m)
        {case 'next':var n = q._.focusIndex,o = q.element.getElementsByTag('a'),p;while (p = o.getItem(++n))
        {
        ...
        }return false;case 'prev':n = q._.focusIndex;o = q.element.getElementsByTag('a');while (n > 0 && (p = o.getItem(--n)))
        {
            if (p.getAttribute('_cke_focus') && p.$.offsetWidth)
            {
                q._.focusIndex = n;
        ...
        }return false;case 'click':n = q._.focusIndex;p = n >= 0 && q.element.getElementsByTag('a').getItem(n);if (p)p.$.click ? p.$.click() : p.$.onclick();return false;
        }
        return true;
    }}});
    j.add('listblock', {requires:['panel'],onLoad:function() {
        ...
        k.listBlock = e.createClass({base:k.panel.block,$:function(l, m) {
            var p = this;
            m = m || {};
    ...
    a.themes.add('default', (function() {
        function l(m, n) {
            ...
            if (p)
            {
                var q = '<span class="cke_shared"><span class="' + m.skinClass + ' cke_editor_' + m.name + '">' + '<span class="' + b.cssClass + '">' + '<span class="cke_wrapper cke_' + m.lang.dir + '">' + '<span class="cke_editor">' + '<div class="cke_' + n + '">' + '</div></span></span></span></span></span>',r = p.append(h.createFromHtml(q, p.getDocument()));
        ...
        ;
        return{build:function(m, n) {
            var o = m.name,p = m.element,q = m.elementMode;
            if (!p || q == 0)return;
            if (q == 1)p.hide();
            var r = m.fire('themeSpace', {space:'top',html:''}).html,s = m.fire('themeSpace', {space:'contents',html:''}).html,t = m.fireOnce('themeSpace', {space:'bottom',html:''}).html,u = s && m.config.height,v = m.config.tabIndex || m.element.getAttribute('tabindex') || 0;
