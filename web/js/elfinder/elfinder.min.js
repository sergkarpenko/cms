(function(a) {
    ...
    elFinder.prototype.options = {url:"",lang:"en",cssClass:"",wrap:14,places:"Places",placesFirst:true,editorCallback:null,cutURL:"",closeOnEditorCallback:true,i18n:{},view:"icons",width:"",height:"",disableShortcuts:false,rememberLastDir:true,cookie:{expires:30,domain:"",path:"/",secure:false},toolbar:[
        ...
        ["info","quicklook"],
        ["icons","list"]
    ],contextmenu:{cwd:["reload","delim","mkdir","mkfile","upload","delim","paste","delim","info"],file:["select","open","quicklook","delim","copy","cut","rm","delim","duplicate","rename","edit","resize","archive","extract","delim","info"],group:["copy","cut","rm","delim","archive","extract","delim","info"]},dialog:null,docked:false,autoReload:0};
    a.fn.elfinder = function(b) {
        return this.each(function() {
            ...
            switch (c)
            {case"close":case"hide":this.elfinder.close();break;case"open":case"show":this.elfinder.open();break;case"dock":this.elfinder.dock();break;case"undock":this.elfinder.undock();break
            }
        })
    }
})(jQuery);
...
(function(a) {
    elFinder.prototype.ui = function(c) {
        ...
        this.showMenu = function(i) {
            ...
            this.menu.css({left:((i.clientX + d.cW) > d.width ? (i.clientX - d.cW) : i.clientX),top:((i.clientY + d.cH) > d.height && i.clientY > d.cH ? (i.clientY + d.sT - d.cH) : i.clientY + d.sT)}).show().find("div[name]").hover(
                                                                                                                                                                                                                                       function() {
        ...
        this.init = function(k) {
            ...
            if (!b.fm.params.archives.length && a.inArray("archive", k) == -1)
            {
                k.push("archive")
            }
            ...
            for (h = 0; h < e.length; h++)
            {
                ...
                for (d = 0; d < e[h].length; d++)
                {
                    ...
                    {
                        m = true;
                        this.buttons[o] = a('<li class="' + o + '" title="' + this.cmdName(o) + '" name="' + o + '" />').appendTo(this.fm.view.tlb).click(
                                                                                                                                                         function(i) {
                                                                                                                                                             i.stopPropagation()
    ...
    elFinder.prototype.ui.prototype.commands = {back:function(c) {
        ...
        this.exec = function() {
            ...
            if (i.length == 1)
            {
                ...
                k = l.html();
                e = a('<input type="text" />').val(j.name).appendTo(l.empty()).bind("change blur", d).keydown(
                                                                                                             function(m) {
                                                                                                                 m.stopPropagation();
                                                                                                                 if (m.keyCode == 27)
                                                                                                                 {
        ...
        this.exec = function() {
            ...
            {
                this.fm.lockShortcuts(true);
                a('<div><div class="ui-state-error ui-corner-all"><span class="ui-icon ui-icon-alert"/><strong>' + this.fm.i18n("Are you shure you want to remove files?<br /> This cannot be undone!") + "</strong></div></div>").dialog({title:this.fm.i18n("Confirmation required"),dialogClass:"el-finder-dialog",width:350,close:function() {
                    b.fm.lockShortcuts()
        ...
        this.exec = function() {
            ...
            e.select().focus().bind("change blur", d).click(
                                                           function(j) {
                                                               j.stopPropagation()
                                                           }).keydown(function(j) {
                j.stopPropagation();
        ...
        this.exec = function() {
            ...
            k = a(k + "</form>");
            o.append(k.append(l.hide()).prepend(h).append(q)).dialog({dialogClass:"el-finder-dialog",title:b.fm.i18n("Upload files"),modal:true,resizable:false,close:function() {
                b.fm.lockShortcuts()
            },buttons:{Cancel:function() {
                a(this).dialog("close")
            },Ok:function() {
            ...
            function n() {
                var t = a('<iframe name="' + g + '" name="' + g + '" src="about:blank"/>'),u = t[0],i = 50,s,e,r;
                t.css({position:"absolute",top:"-1000px",left:"-1000px"}).appendTo("body").bind("load", function() {
                    t.unbind("load");
                    d()
                });
                b.fm.lock(true);
                ...
                function d() {
                    try
                    {
                        s = u.contentWindow ? u.contentWindow.document : u.contentDocument ? u.contentDocument : u.document;
                        if (s.body == null || s.body.innerHTML == "")
                        {
                            if (--i)
                            {
                        ...
                        } else
                        {
                            ...
                            {
                                r = window.JSON && window.JSON.parse ? window.JSON.parse(e) : (new Function("return " + e))()
                            } else
                            {
                                r = {error:"Unable to parse server response"}
                            }
                        }
                    } catch(v)
                    {
                    ...
                    m();
                    r.error && b.fm.view.error(r.error, r.errorData);
                    r.cwd && b.fm.reload(r);
                    r.tmb && b.fm.tmb()
                }
        ...
        this.exec = function() {
            ...
            this.fm.ajax({cmd:"read",current:this.fm.cwd.hash,target:d.hash}, function(g) {
                b.fm.lockShortcuts(true);
                var e = a("<textarea/>").val(g.content || "").keydown(function(h) {
                    h.stopPropagation()
                });
        ...
        this.isAllowed = function() {
            ...
            {
                var d = this.fm.getSelected()[0];
                return d.write && (d.mime.indexOf("text") == 0 || d.mime == "application/x-empty" || d.mime == "application/xml")
            }
        };
        this.cm = function(d) {
            return d == "file"
        ...
        this.isAllowed = function() {
            return this.fm.cwd.write && this.fm.selected.length == 1 && this.fm.getSelected(0).read && this.fm.params.extract.length && a.inArray(this.fm.getSelected(0).mime, this.fm.params.extract) != -1
        };
        this.cm = function(d) {
            return d == "file"
        }
...
(function(a) {
    elFinder.prototype.quickLook = function(l, b) {
        ...
        this.win = a('<div class="el-finder-ql"/>').hide().append(a('<div class="el-finder-ql-drag-handle"/>').append(a('<span class="ui-icon ui-icon-circle-close"/>').click(function() {
            p.hide()
        })).append(this.title)).append(this.ico).append(this.media).append(this.content.append(this.name).append(this.kind).append(this.size).append(this.date).append(this.url).append(this.add)).appendTo(document.body).draggable({handle:".el-finder-ql-drag-handle"}).resizable({minWidth:420,minHeight:150,resize:function() {
            if (p.media.children().length)
            {
                var m = p.media.children(":first");
                switch (m[0].nodeName)
                {case"IMG":var e = m.width(),n = m.height(),i = p.win.width(),s = p.win.css("height") == "auto" ? 350 : p.win.height() - p.content.height() - p.th,q = e > i || n > s ? Math.min(Math.min(i, e) / e, Math.min(s, n) / n) : Math.min(Math.max(i, e) / e, Math.max(s, n) / n);m.css({width:Math.round(m.width() * q),height:Math.round(m.height() * q)});break;case"IFRAME":case"EMBED":m.css("height", p.win.height() - p.content.height() - p.th);break;case"OBJECT":m.children("embed").css("height", p.win.height() - p.content.height() - p.th)
                }
            }
        }});
        ...
        this.show = function() {
            if (this.win.is(":hidden") && p.fm.selected.length == 1)
            {
                ...
                this.win.css({width:e.width() - 20,height:e.height(),left:i.left,top:i.top,opacity:0}).animate({width:420,height:150,opacity:1,top:Math.round(a(window).height() / 5),left:a(window).width() / 2 - 210}, 450, function() {
    ...
    elFinder.prototype.quickLook.prototype.plugins = {image:new function() {
        ...
        this.show = function(e, d) {
            ...
            function g(k) {
                ...
                e.ico.hide();
                k.css({width:e.ico.width(),height:e.ico.height()}).animate({width:Math.round(n * j),height:Math.round(n * m)}, 450, function() {
                    e.fm.lockShortcuts()
                })
            }
        }
    ...
    elFinder.prototype.eventsManager = function(d, c) {
        ...
        this.init = function() {
                         ...
                         function(h) {
                             ...
                             } else
                             {
                                ...
                                function(h) {
                                    ...
                                    h.preventDefault();
                                    h.stopPropagation();
                                    if (g.hasClass("el-finder-cwd"))
                                    {
                                        b.fm.unselectAll()
                                    } else
                                    {
                                        b.fm.select(g.attr("key") ? g : g.parent("[key]"))
                                    }
                                    b.fm.quickLook.hide();
                                    b.fm.ui.showMenu(h)
            ...
            a(document).bind("click", function() {
                b.fm.ui.hideMenu();
                a("input", b.cwd).trigger("change")
            });
            this.tree.bind("select", function(g) {
                b.tree.find("a").removeClass("selected");
                a(g.target).addClass("selected").parents("li:has(ul)").children("ul").show().prev().children("div").addClass("expanded")
            });
            if (this.fm.options.places)
            {
                this.fm.view.plc.click(function(k) {
                    k.preventDefault();
                    var i = a(k.target),j = i.attr("key"),g;
                    if (j)
                    {
                        j != b.fm.cwd.hash && b.ui.exec("open", k.target)
                    } else
                    {
                        if (k.target.nodeName == "A" || k.target.nodeName == "DIV")
                        {
                            g = b.fm.view.plc.find("ul");
                            if (g.children().length)
                            {
                                g.toggle(300);
                                b.fm.view.plc.children("li").find("div").toggleClass("expanded")
                            }
                        }
                    }
                });
                this.fm.view.plc.droppable({accept:"(div,tr).directory",tolerance:"pointer",over:function() {
                    ...
                    a(this).removeClass("el-finder-droppable");
                    var g = false;
                    h.helper.children(".directory:not(.noaccess,.dropbox)").each(function() {
                        if (b.fm.addPlace(a(this).attr("key")))
                        {
                            g = true;
                            a(this).hide()
                        }
                    ...
                    if (g)
                    {
                        b.fm.view.renderPlaces();
                        b.updatePlaces();
                        b.fm.view.plc.children("li").children("div").trigger("click")
                    }
                    if (!h.helper.children("div:visible").length)
                    {
                        h.helper.hide()
                    }
                }})
            }
            a(document).bind(a.browser.mozilla || a.browser.opera ? "keypress" : "keydown", function(h) {
                var g = h.ctrlKey || h.metaKey;
                if (b.lock)
                {
                    return
                }
                switch (h.keyCode)
                {case 37:case 38:h.stopPropagation();h.preventDefault();if (h.keyCode == 37 && g)
                {
                    b.ui.execIfAllowed("back")
                } else
                {
                    e(false, !h.shiftKey)
                }break;case 39:case 40:h.stopPropagation();h.preventDefault();if (g)
                {
                    b.ui.execIfAllowed("open")
                } else
                {
                    e(true, !h.shiftKey)
                }break
            ...
            a(document).bind(a.browser.opera ? "keypress" : "keydown", function(g) {
                if (b.lock)
                {
                    return
                }
                switch (g.keyCode)
                {case 32:g.preventDefault();g.stopPropagation();b.fm.quickLook.toggle();break;case 27:b.fm.quickLook.hide();break
                }
            });
            if (!this.fm.options.disableShortcuts)
            {
                a(document).bind("keydown", function(h) {
                    var g = h.ctrlKey || h.metaKey;
                    if (b.lock)
                    {
                        return
                    ...
                    switch (h.keyCode)
                    {case 8:if (g && b.ui.isCmdAllowed("rm"))
                    {
                        h.preventDefault();
                        b.ui.exec("rm")
                    }break;case 13:if (b.ui.isCmdAllowed("select"))
                    {
                        return b.ui.exec("select")
                    }b.ui.execIfAllowed("open");break;case 46:b.ui.execIfAllowed("rm");break;case 65:if (g)
                    {
                        h.preventDefault();
                        b.fm.selectAll()
                    }break;case 67:g && b.ui.execIfAllowed("copy");break;case 73:if (g)
                    {
                        h.preventDefault();
                        b.ui.exec("info")
                    }break;case 78:if (g)
                    {
                        h.preventDefault();
                        b.ui.execIfAllowed("mkdir")
                    }break;case 85:if (g)
                    {
                        h.preventDefault();
                        b.ui.execIfAllowed("upload")
                    }break;case 86:g && b.ui.execIfAllowed("paste");break;case 88:g && b.ui.execIfAllowed("cut");break;case 113:b.ui.execIfAllowed("rename");break
                    }
                })
            }
        };
        this.updateNav = function() {
            ...
            a("a:not(.noaccess,.readonly)", this.tree).droppable({tolerance:"pointer",accept:"(div,tr)[key]",over:function() {
                a(this).addClass("el-finder-droppable")
            },out:function() {
                a(this).removeClass("el-finder-droppable")
            },drop:function(h, g) {
        ...
        this.updateCwd = function() {
            ...
            }}).filter(".directory").droppable({tolerance:"pointer",accept:"(div,tr)[key]",over:function() {
                a(this).addClass("el-finder-droppable")
            },out:function() {
                a(this).removeClass("el-finder-droppable")
            },drop:function(h, g) {
            ...
            if (a.browser.msie)
            {
                a("*", this.cwd).attr("unselectable", "on").filter("[key]").bind("dragstart",
                                                                                function() {
