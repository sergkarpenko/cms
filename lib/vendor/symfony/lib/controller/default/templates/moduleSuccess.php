...
<dl class="sfTMessageInfo">
  ...
  <dd>This page is part of the symfony <code>default</code> module. It will disappear as soon as you override the <code>index</code>
    action in the new module.
  </dd>

  <dt>What's next</dt>
  <dd>
    <ul class="sfTIconList">
      <li class="sfTDirectoryMessage">Browse to the
        <code>apps/<?php echo sfContext::getInstance()->getConfiguration()->getApplication() ?>
          /modules/<?php echo $sf_params->get('module') ?>/</code> directory
      </li>
      <li class="sfTEditMessage">In <code>actions/actions.class.php</code>, edit the <code>executeIndex()</code> method
        and remove the final <code>forward</code></li>
